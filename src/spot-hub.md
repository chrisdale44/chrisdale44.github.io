...
>
  <div class="bg-[#157] flex align-center justify-center text-center w-full">
    <a href="https://spot-hub.app" target="_blank"
      ><h1 class="pacifico text-white text-4xl p-4">
  ...
  <div class="px-8 pb-8">
      ...
      <div class="flex-1">
        <section class="text-sm">
          <h2 class="text-md font-bold mb-4 pb-2">
            A Progressive Web App for mapping skateboarding spots and
            skateboarding media across the globe
          </h2>
          <p class="text-gray-700 mb-4 text-sm">
            Designed to fill a gap in the skateboarding community, Spot Hub is a
            project that enables users to discover skateboard spots and street
            obstacles worldwide, and document the history of tricks performed at
          ...
          <p class="text-sm">
            The Spot Hub codebase is currently private for security reasons but
            access to the Github repo can be granted upon request.
          </p>
        </section>
      </div>
        ...
        <table class="w-full border-collapse">
          <thead>
            <tr class="border-b border-gray-200">
              <th class="text-left py-3 px-4 font-bold w-1/4">Technology</th>
              <th class="text-left py-3 px-4 font-bold w-3/4">
          ...
          <tbody class="divide-y divide-gray-200">
            <tr>
              ...
              <td class="py-3 px-4">
                <ul class="list-disc pl-5 space-y-1">
                  <li>
                    Modern Javascript Library for building reusable UI
                    components
                  </li>
                  <li>
                    Rich developer community and ecosystem of compatible
                    libraries
                  </li>
                </ul>
              </td>
            ...
            <tr>
              ...
              <td class="py-3 px-4">
                <ul class="list-disc pl-5 space-y-1">
                  <li>
                    React-based framework for SSR (faster page loads and better
                    SEO)
                  </li>
            ...
            <tr>
              <td class="py-3 px-4 align-top font-semibold">MapLibreGL</td>
              <td class="py-3 px-4">
                <ul class="list-disc pl-5">
                  <li>
                    Free WebGL mapping library (MapBox fork) for smooth
            ...
            <tr>
              ...
              <td class="py-3 px-4">
                <ul class="list-disc pl-5">
                  <li>
                    WebGL visualisation for scalable map pin layers with GPU
                    acceleration
                  </li>
                </ul>
              </td>
            ...
            <tr>
              ...
              <td class="py-3 px-4">
                <ul class="list-disc pl-5 space-y-1">
                  <li>
                    Open Source Serverless PostgreSQL with demand-based scaling
                  </li>
                  <li>
                    PostGIS for optimised GeoSpatial data querying and indexing
                  </li>
                  <li>PostgreSQL functions for complex querying</li>
                  <li>
                    Row Level Security for granular role-based access control
                  </li>
                  <li>
                    Automatically built RESTful API's reduces CRUD endpoint
                    management
                  </li>
                </ul>
              </td>
            ...
            <tr>
              ...
              <td class="py-3 px-4">
                <ul class="list-disc pl-5">
                  <li>
                    Simple, secure authentication without storing passwords
                  </li>
                </ul>
              </td>
            </tr>
            <tr>
              ...
              <td class="py-3 px-4">
                <ul class="list-disc pl-5">
                  <li>
                    Form validation library to prevent errors and improve UX
                  </li>
                </ul>
              </td>
            </tr>
            <tr>
              ...
              <td class="py-3 px-4">
                <ul class="list-disc pl-5 space-y-1">
                  ...
                  <li>
                    Powerful API's for automated image transformation and
                    optimisation
                  </li>
                </ul>
              </td>
            ...
            <tr>
              <td class="py-3 px-4 align-top font-semibold">
                React Intersection Observer
              </td>
              <td class="py-3 px-4">
                <ul class="list-disc pl-5">
                  <li>
                    Lazy loading images below the fold for faster page loads
                  </li>
                </ul>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td class="py-3 px-4">
                <ul class="list-disc pl-5">
                  <li>
                    Customisable React components with built-in accessibility
                  </li>
                </ul>
              </td>
            </tr>
            <tr>
              ...
              <td class="py-3 px-4">
                <ul class="list-disc pl-5">
                  <li>
                    Utility-first CSS design system for rapid development and
                    consistent styling
                  </li>
                </ul>
              </td>
            ...
            <tr>
              ...
              <td class="py-3 px-4">
                <ul class="list-disc pl-5">
                  <li>
                    IndexedDB wrapper for local data caching to improve load
                    times
                  </li>
                </ul>
              </td>
            ...
            <tr>
              ...
              <td class="py-3 px-4">
                <ul class="list-disc pl-5">
                  <li>
                    A collection of JS Libraries for implementing PWA's with
                    Service Workers, used to simplify service worker generation,
            ...
            <tr>
              ...
              <td class="py-3 px-4">
                <ul class="list-disc pl-5 space-y-1">
                  <li>
                    Serverless deployment with built-in CDN used for
            ...
            <tr>
              ...
              <td class="py-3 px-4">
                <ul class="list-disc pl-5 space-y-1">
                  <li>
                    Fast, low-config Javascript and React unit testing framework
                  </li>
                </ul>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td class="py-3 px-4">
                <ul class="list-disc pl-5">
                  <li>
                    Version control for feature branching and production/staging
                    branch management
                  </li>
                </ul>
              </td>
    ...
    <section class="mb-8 text-sm w-full" id="performance">
      ...
      <p class="mb-4">
        Many JavaScript map libraries use DOM nodes to render map layers, such
        as map pins. However, this approach lacks scalability as maps with
        thousands of pins will suffer from sluggish performance. Instead, Spot
        Hub uses DeckGL, a WebGL library that leverages GPU acceleration for
    ...
    <section class="mb-8 text-sm w-full" id="ci-cd">
      ...
      <p>
        Using Netlify and Github I have a very simple CI/CD workflow that
        automatically deploys commits to my Production or Staging Environments
        using Github Actions when changes are merged into to the
        <code class="bg-gray-100 px-1 rounded">main</code> or
        <code class="bg-gray-100 px-1 rounded">staging</code> branches. I also
        have a Staging and Production instance of the Supabase database to avoid
        any accidental or breaking changes made to the Production database
        during development.
      </p>
    </section>
    <section class="mb-8 text-sm w-full" id="next-steps">
      ...
      <ul class="list-disc pl-6 space-y-2">
        ...
        <li>
          <strong>JSDoc</strong> or <strong>TypeScript</strong> for type
          checking as the app grows in complexity
        </li>
        <li>
